...
In scenarios where accuracy is important, you should not rely on the detection results of small models, use `low_memory=False` to load larger models from internet!
